...
exports.updateUserById = exports.getUserById = exports.getAllUsers = exports.deleteUserById = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _user["default"].findById(req.params.userId).select('-password');
        case 3:
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 8:
          res.json({
            message: "User with id: ".concat(req.params.userId, " is successfully deleted")
          });
          _context4.next = 14;
          break;
        case 11:
